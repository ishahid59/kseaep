        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button @click="prodacdelete()" type="button" data-dismiss="modal" class="btn btn-danger" id="delete">Delete</button>
  ...
  <div class="modal fade" id="prodacdetailmodal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content" style=" width:800px">
        ...
        <div class="modal-body" id="detailsprodacview" style="padding:40px;padding-top:25px; padding-bottom:0px;">
    ...
    <div class="row">
        ...
        <!-- start right col -->  
          ...
          <dl class="dl-horizontal" style="margin-bottom:0px;">
            ...
            <dt><u>Completion date comment</u></dt>
            <!-- <dd id="ddBidDate">{{prodac.CompletionDateComment}}</dd> -->
            <br><div style="line-height:1.3;margin-bottom:5px;margin-top:2px;font-size:13px;">{{prodac.CompletionDateComment}}</div>
            <dt><u>Total project cost comment</u></dt>
            <!-- <dd id="ddBidDate">{{prodac.TotalProjectCostComment}}</dd> -->
            <br><div style="line-height:1.3;margin-bottom:5px;margin-top:2px;font-size:13px;">{{prodac.TotalProjectCostComment}}</div>
            <dt><u>Firm cost comment</u></dt>
            <!-- <dd id="ddBidDate">{{prodac.FirmCostComment}}</dd> -->
            <br><div style="line-height:1.3;margin-bottom:5px;margin-top:2px;font-size:13px;">{{prodac.FirmCostComment}}</div>
            <dt><u>Notes</u></dt>
            <!-- <dd id="ddBidDate">{{prodac.Notes}}</dd> -->
            <br><div style="line-height:1.3;margin-bottom:10px;margin-top:2px;font-size:13px;">{{prodac.Notes}}</div>
            <dt>Project on hold</dt>
            <!-- <dd id="ddBidDate">{{prodac.ProjectOnHold}}</dd> -->
            <dd>
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group" >
              ...
              <div class="col-sm-6" style="padding-left:0px;">
                <input   type="date" 
                  ...
                  v-model="formdata.BidDate"
                />
                <div style="width:350px; "
                  v-if="formErrors['BidDate']"
            ...
            <div class="form-group" >
              ...
              <div class="col-sm-6" style="padding-left:0px;">
                <input   type="text" 
                  ...
                  id="BidYear"  
                  class="form-control"   
                  v-model="formdata.BidYear"
                />
                <div style="width:350px; "
                  v-if="formErrors['BidYear']"
                  class="error text-danger"
            ...
            <div class="form-group" >
              ...
              <div class="col-sm-6" style="padding-left:0px;">
                <input type="date" 
                  ...
                  class="form-control startdate"   
                  placeholder="mm/dd/yyyy" 
                  v-model="formdata.NTPStartDate"
                />
                <div style="width:350px; "
                  v-if="formErrors['NTPStartDate']"
                  class="error text-danger"
            ...
            <div class="form-group" >
              ...
              <div class="col-sm-6" style="padding-left:0px;">
                <input type="date" 
                  ...
                  class="form-control startdate"   
                  placeholder="mm/dd/yyyy" 
                  v-model="formdata.EstCompletionDate"
                />
                <div style="width:350px; "
                  v-if="formErrors['EstCompletionDate']"
                  class="error text-danger"
             ...
             <div class="form-group" >
              ...
              <div class="col-sm-6" style="padding-left:0px;">
                <input type="text" 
                  name="EstCompletionYear"   
                  id="EstCompletionYear"  
                  class="form-control"   
                  v-model="formdata.EstCompletionYear"
                />
                <div style="width:350px; "
                  v-if="formErrors['EstCompletionYear']"
                  class="error text-danger"
            ...
            <div class="form-group" >
              ...
              <div class="col-sm-6" style="padding-left:0px;">
                ...
                />
                <div style="width:350px; "
                  v-if="formErrors['ActualCompletionDate']"
                  class="error text-danger"
             ...
             <div class="form-group" >
              ...
              <div class="col-sm-6" style="padding-left:0px;">
                <input type="text" 
                  ...
                  id="ActualCompletionYear"  
                  class="form-control"   
                  v-model="formdata.ActualCompletionYear"
                />
                <div style="width:350px; "
                  v-if="formErrors['ActualCompletionYear']"
                  class="error text-danger"
            ...
            <div class="form-group" >
              ...
              <div class="col-sm-6" style="padding-left:0px;">
                ...
                />
                <div style="width:350px; "
                  v-if="formErrors['ConstructionCompletionDate']"
                  class="error text-danger"
                 >{{ formErrors['ConstructionCompletionDate'][0]}}
                </div>  
              </div>
            </div>  
             ...
             <div class="form-group" >
              ...
              <div class="col-sm-6" style="padding-left:0px;">
                <input type="text" 
                  name="ConstructionCompletionYear"   
                  id="ConstructionCompletionYear"  
                  class="form-control"   
                  v-model="formdata.ConstructionCompletionYear"
                />
                <div style="width:350px; "
                  v-if="formErrors['ConstructionCompletionYear']"
                  class="error text-danger"
                 >{{ formErrors['ConstructionCompletionYear'][0]}}
                </div>  
              </div>
            </div>  
            ...
            <div class="form-group" >
              ...
              <div class="col-sm-6" style="padding-left:0px;">
                <input type="text" 
                  ...
                  id="PersentageComplete"  
                  class="form-control"   
                  v-model="formdata.PersentageComplete"
                />
                <div style="width:350px; "
                  v-if="formErrors['PersentageComplete']"
                  class="error text-danger"
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6" style="padding-left:0px;">
                <input type="date" 
                  name="PersentageCompleteDate"   
                  id="PersentageCompleteDate"  
                  class="form-control startdate"   
                  placeholder="mm/dd/yyyy" 
                  v-model="formdata.PersentageCompleteDate"
                />
                <div style="width:350px; "
                  v-if="formErrors['PersentageCompleteDate']"
                  class="error text-danger"
      ...
      <div  class="col-sm-6" style="padding-left:15px;padding-right:40px;">
        <!-- start right col -->
            ...
            <div class="form-group">
              <label class="control-label col-sm-6">Construction cost</label>
              <div class="col-sm-6" style="padding-left:0px;">
                <input type="text" 
                ...
                />
                <div style="width:350px; "
                  v-if="formErrors['ConstructionCost']"
                  class="error text-danger"
            ...
            <div class="form-group" >
              <label class="control-label col-sm-6">Total project fee</label>
              <div class="col-sm-6" style="padding-left:0px;">
                <input type="text" 
                ...
                />
                <div style="width:350px; "
                  v-if="formErrors['TotalProjectFee']"
                  class="error text-danger"
            ...
            <div class="form-group" >
              <label class="control-label col-sm-6">Firm fee</label>
              <div class="col-sm-6" style="padding-left:0px;">
                <input type="text" 
                  name="FirmFee"   
                  id="FirmFee"  
                  class="form-control"   
                  v-model="formdata.FirmFee"
                />
                <div style="width:350px; "
                  v-if="formErrors['FirmFee']"
                  class="error text-danger"
            ...
            <div class="form-group" >
              <label class="control-label col-sm-6" style="padding-right:0px">Completion date comment</label>
              <!-- <div class="col-sm-6" style="padding-left:0px;"> -->
                <textarea type="text" 
                  name="CompletionDateComment"   
                  id="CompletionDateComment"  
                  class="form-control"   
                  v-model="formdata.CompletionDateComment"
                />
                <div style="width:350px; "
                  v-if="formErrors['CompletionDateComment']"
                  class="error text-danger"
                 >{{ formErrors['CompletionDateComment'][0]}}
                </div>  
              <!-- </div> -->
            </div>  
            ...
            <div class="form-group" >
              <label class="control-label col-sm-6" style="padding-right:0px">Total project cost comment</label>
              <!-- <div class="col-sm-6" style="padding-left:0px;"> -->
                <textarea type="text" 
                ...
                />
                <div style="width:350px; "
                  v-if="formErrors['TotalProjectCostComment']"
                  class="error text-danger"
                 >{{ formErrors['TotalProjectCostComment'][0]}}
                </div>  
              <!-- </div> -->
            </div>  
            ...
            <div class="form-group" >
              <label class="control-label col-sm-6">Firm cost comment</label>
              <!-- <div class="col-sm-6" style="padding-left:0px;"> -->
                <textarea type="text" 
                ...
                />
                <div style="width:350px; "
                  v-if="formErrors['FirmCostComment']"
                  class="error text-danger"
                 >{{ formErrors['FirmCostComment'][0]}}
                </div>  
              <!-- </div> -->
            </div> 
             ...
             <div class="form-group"  >
              <label class="control-label col-sm-6" >Notes</label>
              <!-- <div class="col-sm-6" style="padding-left:0px;"> -->
                <textarea type="text"  class="form-control"  name="Notes" id="Notes" style="height:auto;margin-bottom:0px;"  v-model="formdata.Notes" ></textarea>
                   <div style="width:340px; "
                    v-if="formErrors['Notes']"
                    class="error text-danger"
                  >{{ formErrors['Notes'][0]}}
            ...
            <!-- <div class="form-group" >
              <label class="control-label col-sm-6">Project on hold</label>
              <div class="col-sm-6" style="padding-left:0px;"> -->
                  ...
                  <!-- <input
                   ...
                   :false-value="0"
                    ...
                    name="ProjectOnHold"
                    id="ProjectOnHold"
                    v-model="formdata.ProjectOnHold"
            ...
            <div class="form-group" >
              <label class="control-label col-sm-3" style="padding-right:0px"
...
<!-- <a id="btnAddModal" href="{% url 'create_empdegree' 1 %}" style="float:right;margin-right:5px;margin-top:-22px;cursor:pointer;" onclick="addEditEmpDegree(0)"><i class="fa fa-plus"></i> Add New</a>   -->
    ...
    <a id="btnAddModal" style="float:right;margin-right:10px;margin-top:-31px;cursor:pointer; color:#006fae;" v-on:click="prodacshowaddmodal"><i class="fa fa-plus"></i> Add New</a>
    
    <a id="btnAddModal" style="float:right;margin-right:10px;margin-top:5px;cursor:pointer; color:#006fae;" v-on:click="prodacconfirmdelete"> Delete</a>   
    <a id="btnAddModal" style="float:right;margin-right:3px;margin-top:5px;cursor:pointer; color:#006fae;" v-on:click="prodacshoweditmodal">Edit |</a>
    <a id="btnAddModal" style="float:right;margin-right:3px;margin-top:5px;cursor:pointer; color:#006fae;" v-on:click="prodacshowdetailmodal">View |</a>
  

    <!-- <table id="prodacTable" class="table table-striped table-bordered" style="width:100%;">
        <thead >
            <tr>
      ...
      >
        <div class="col-sm-4" style="margin-right:0px;">
          <dl class="dl-horizontal" >
            ...
            <dd id="ddBidDate">{{prodac.EstCompletionDate}}</dd>
            <dt>Estimated completion year</dt>
            <dd id="ddBidDate">{{prodac.EstCompletionYear}}</dd>
        ...
        <div class="col-sm-4 " style="padding-right:0px;" >
          <dl class="dl-horizontal " style=" margin-top:0; margin-bottom:0px;">
            <dt style="width: 220px;">Actual completion date</dt>
            <dd id="ddBidDate">{{prodac.ActualCompletionDate}}</dd>
            <dt style="width: 220px;">Actual completion year</dt>
            <dd id="ddBidDate">{{prodac.ActualCompletionYear}}</dd>
            <dt style="width: 220px;">Construction completion date</dt>
            <dd id="ddBidDate">{{prodac.ConstructionCompletionDate}}</dd>
            <dt style="width: 220px;">Construction completion year</dt>
            <dd id="ddBidDate">{{prodac.ConstructionCompletionYear}}</dd>
            <dt style="width: 220px;">Persentage complete</dt>
            <dd id="ddBidDate">{{prodac.PersentageComplete}}</dd>
            <dt style="width: 220px;">Persentage complete date</dt>
            <dd id="ddBidDate">{{prodac.PersentageCompleteDate}}</dd>
            <dt style="width: 220px;">Construction cost</dt>
            <dd id="ddBidDate">{{prodac.ConstructionCost}}</dd>
        ...
        <div class="col-sm-4" style="padding-right:0px;" >
          <dl class="dl-horizontal" style=" margin-top:0; margin-bottom:0px;">
            ...
            <dd id="ddBidDate" style="overflow: hidden;max-width:180px;white-space: nowrap;text-overflow: ellipsis;">{{prodac.CompletionDateComment}}</dd>
            <dt >Total project cost comment</dt>
            <dd id="ddBidDate" style="overflow: hidden;max-width:180px;white-space: nowrap;text-overflow: ellipsis;">{{prodac.TotalProjectCostComment}}</dd>
            <dt>Firm cost comment</dt>
            <dd id="ddBidDate" style="overflow: hidden;max-width:180px;white-space: nowrap;text-overflow: ellipsis;">{{prodac.FirmCostComment}}</dd>
            <dt>Notes</dt>
            <dd id="ddBidDate" style="overflow: hidden;max-width:180px;white-space: nowrap;text-overflow: ellipsis;">{{prodac.Notes}}</dd>
            <dt>Project on hold</dt>
            <!-- <dd id="ddBidDate">{{prodac.ProjectOnHold}}</dd> -->
            <dd>
                <input id="ddEmployee_Consultant" v-model="prodac.ProjectOnHold" :true-value="1" class="check-box" type="checkbox" />
...
<!-- this will store the empid on datatable row click -->
    ...
    <input type="text"  id="prodachiddenempid"  hidden/><!-- hyperlink employee detail page will store empid-->
...
export default {
    ...
    openemployeedetailpage(){
      ...
      prodacshowdetailmodal(){
            ...
            // .get("apiprodacdetaildata/" + this.id + "").then(response => {
             .get("apiprodacdetaildata/" + this.$parent.projectid + "").then(response => { // for single record use projectid
            ...
            // if (this.prodac.DurationFrom!=null) {
            //     let userDate = this.prodac.DurationFrom;//'1999-02-13 00:00:00';
            //     var date_string = moment(userDate, "YYYY-MM-DD").format("MM/DD/YYYY");
            //     this.prodac.DurationFrom=date_string;
            //     // $("#ddDurationFrom").html('');
            // }
            // if (this.prodac.DurationTo!=null) {
            //     let userDate = this.prodac.DurationTo;//'1999-02-13 00:00:00';
            //     var date_string = moment(userDate, "YYYY-MM-DD").format("MM/DD/YYYY");
            //     this.prodac.DurationTo=date_string;
            //     // $("#ddDurationTo").html('');
            // }

            // // to show blank in detail modal if date is default '1900-01-01 00:00:00'
            // if (this.prodac.DurationFrom==='01/01/1900') {
            //     this.prodac.DurationFrom="";
            //     // $("#ddDurationFrom").html('');
            // }
            // if (this.prodac.DurationTo==='01/01/1900') {
            //     this.prodac.DurationTo="";
            //     // $("#ddDurationTo").html('');
            // }
            // if (this.prodac.created_at!=null) {
            //     let userDate = this.prodac.created_at;//'1999-02-13 00:00:00';
            //     var date_string = moment(userDate, "YYYY-MM-DD").format("MM/DD/YYYY");//"MM-DD-YYYY HH:mm:ss"
            //     this.prodac.created_at=date_string;
            // }
            // if (this.prodac.updated_at!=null) {
            //     let userDate = this.prodac.updated_at;//'1999-02-13 00:00:00';
            //     var date_string = moment(userDate, "YYYY-MM-DD").format("MM/DD/YYYY");//"MM-DD-YYYY HH:mm:ss"
            //     this.prodac.updated_at=date_string;
            // }
     ...
     // Edit click
      prodacshoweditmodal(){
        ...
        axios
            ...
            .get("apiprodaceditdata/" + this.$parent.projectid + "").then(response => { // for single record use projectid
      ...
      refreshprodactab(){
          ...
          axios
          // .get("apiprodacdetaildata/" + this.id + "").then(response => {
          .get("apiprodacdetaildata/" + this.projectid + "").then(response => { // use projectid for single record
              if (response.data[0]) {
                this.prodac = response.data[0];
              }
          })
              ...
              .catch((err) => {
                  ...
                  //axios Network Error doesnt have err.response.status, so used seperate condition
                   ...
                   if (err.response.status===422) { 
                        ...
                        // $("#prodactoperrbar").css("height", height+'px');
                        // $('#prodactoperrbar').slideDown();
                        // $("#prodactoperrbar").css("transition", 'height 300ms'); // css transition instead of jquery to slide uo and down
                        

                        // Now using css transition instead of jquery to slide uo and down added in master.blade
                        $("#prodactoperrbar").css("height", height+'px');  
                        // $('#prodactoperrbar').show();
                        return;
                  } 
      ...
      // }
          ...
          axios
            ...
            .post("apiprodacdeletedata/" + this.prodac.ID + "").then(response => {
  ...
  mounted() {
      ...
      // setTimeout(() => {
              ...
              //  var table = $('#prodacTable').DataTable({
              //       "bPaginate": true,
              //       "bLengthChange": false,
              //       "bFilter": false,
              //       "bInfo": true,
              ...
              //       "ajax": {
              //           // "url": "/api/apiprodacdata/",// passing empid through POST request to api
              //           url: baseurldt+"apiprodacdata",
              //           headers: {
              ...
              //                 // trimmedString + '...';
              //               return   "<a onclick=$('#prodachiddenempid').val("+row.EmpID +"); id='prodacempdetailpage' style='cursor:pointer;color: #006fae'>"+ trimmedString + '...' +"</a>"
              //             } else {
              //                 return "<a onclick=$('#prodachiddenempid').val("+row.EmpID +"); id='prodacempdetailpage' style='cursor:pointer;color: #006fae'>"+ data +"</a>";
              //              }
              //         }},
              ...
              //           //    }
              //           // }, 
              //           { "data": "EmpProjectRole","mRender": function(data) {
              //             if(data.length > 70){
              //                 var trimmedString = data.substring(0, 70);
              ...
              //              }
              //           }},
              //           { "data": "SecProjectRole","mRender": function(data) {
              //             if(data.length > 70){
              //                 var trimmedString = data.substring(0, 70);
              //                 return trimmedString + '...';
              //             } else {
              ...
              //                   return(    
              //                       "<a onclick=$('#prodachiddenid').val("+row.ID +"); id='prodacview' style='cursor:pointer'>View</a> | <a onclick=$('#prodachiddenid').val("+row.ID +");  id='prodacedit' style='cursor:pointer'>Edit</a> | <a onclick=$('#prodachiddenid').val("+row.ID +");  id='prodacdelete' style='cursor:pointer'>Delete</a>"
              //                   );
              //                },
              //            } // end col ID
...
// }, 2000) 
    ...
    setTimeout(() => {
      ...
      // ***********************************************************************
            ...
            axios.get("apiprodaccombogroup").then((response) => {
...
#prodacdetailmodal dt,#prodacdetailmodal dd
 {
  font-family: "Helvetica", Arial, sans-serif;
