<template>
  <!-- <div class="container"
    style="width:98%;margin-top:20px;margin-left:20px;margin-right:20px;border: 1px solid #3c8dbc; padding-left:0px; padding-right:0px;"> -->
   
   <div style="border: 1px solid #3c8dbc;">
    <!-- <div v-if="loading" class="testdiv"> -->
      <!-- <img class="imgloading" style="display: block; margin-left: auto;margin-right: auto;" src="../../public/img/loading.gif"> -->
    ...
    <div
      ...
      <h1 style="font-size: 28px; margin-top:0px;margin-bottom:6px">Employee Search</h1>
    </div>
    ...
    <!-- Extra div for Styling Table Div --> <!-- TABLE BODY  -->
    <div class="table-body" style="padding:7px">
    ...
    <!-- END SEARCH FORM DIV -->
      ...
      <button @click="srcreset" class="btn btn-default btn-sm pull-right" style="width: 70px;margin-right:0px;margin-bottom:6px;"><span aria-hidden="true" class="glyphicon glyphicon-refresh"></span> Reset</button>
      <button @click="search" class="btn btn-primary btn-sm pull-right" style="margin-right:5px;width: 80px;background-color: #2a88bd">Search</button> 
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      // **********************************************************************
      setTimeout(() => {
        // axios.get("apiempsearchcombogroup").then((response) => {
        ...
        //       this.lstEmpTraining = response.data.List_EmpTraining;
        //       // project related 
        ...
        this.$axios.get(self.$host + "api/empcombo/empsearch").then((response) => {
      ...
      }, 800); // This promise will be resolved in 2000 milli-seconds
