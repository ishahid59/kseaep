<template>
  <div>
    ...
    <h2 style="margin-top: 10px; margin-bottom: 5px; font-size:25px;">Employee List</h2>
    ...
    <div style="border: 1px solid #3c8dbc;">
      ...
      <div class="table-body" style="padding:7px;  z-index:100;">
        ...
        <a type="button" class="btn btn-default pull-right btn-sm "
          style="margin-left:4px;margin-bottom:10px;color:#006fae;" v-on:click="showempaddmodal"> <span
        ...
        <table id="employeeTable" class="table table-striped table-bordered"
          style="width:100%;border:1px solid #cecece !important;background-color:white">
    ...
    mounted() {
      ...
      $(document).ready(function () {
        ...
        $("#employeeTable").dataTable({
          ...
          processing: true,
          language: {
            processing: "<img src='/img/loading4.gif' style='margin-left:100px'>", //global root(public folder) path
